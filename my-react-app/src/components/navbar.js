...
const App = () => {
  ...
  return (
    <>
      <Header style={{ background: '#fff', zIndex: 1000, width: '100%', position: 'fixed', top: 0, display: 'flex', alignItems: 'center', backgroundColor: colorBgBase, padding: '0 12px', boxShadow: '0 12px 10px -10px rgba(0,0,0,.1)' }}>
        <div className="demo-logo" style={{ fontSize: '22px', color: '#000', fontWeight: 'bold', marginRight: '20px' }}>ColAI</div>
        <Menu
          mode="horizontal"
